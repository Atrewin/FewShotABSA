...
def train_args(parser):
    ...
    group.add_argument("--K", default=5, type=int, help="The num of support instances")
    group.add_argument("--Q", default=2, type=int, help="The num of query instances for each class")
    group.add_argument("--max_length", default=128, type=int, help="The max length of sentences, don't change this param")
    group.add_argument("--iter_num", default=2000, type=int, help="The num of query instances for each class")
...
def model_args(parser):
    ...
    group.add_argument("-e_nm", "--emission_normalizer", type=str, default='none', choices=['softmax', 'norm', 'none'],
                       help="normalize emission into 1-0")
    group.add_argument("-e_scl", "--emission_scaler", type=str, default="learn",
...
def option_check(opt):
    ...
    if opt.label_wp:
        raise ValueError('This function is kept in feature process but not support by current modules.')
    return opt
